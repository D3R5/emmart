        ...
        return (
            <>
                <div className="buttons d-flex justify-content-center mb-5 pb-5">
                    ...
                    <buttons className="btn btn-outline-dark me-2" onClick={()=>filterProduct("jewelery")}>Jewelery</buttons>
                    <buttons className="btn btn-outline-dark me-2" onClick={()=>filterProduct("electronics")}>Electronic</buttons>
                </div>
                {filter.map((product) => {
                    return (
                        <>
